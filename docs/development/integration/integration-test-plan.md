...
| Schema 与本地协议 | schema 建链自动升级、local clone/remote/ls-remote/fetch/pull、shallow fetch、拒绝 file remote push | 2 | 已实现 | `cli.schema-upgrade-observable`, `cli.clone-fetch-pull-local`, `cli.fetch-depth-local`, `cli.push-local-file-remote-rejected` |
